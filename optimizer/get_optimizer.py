...
from gnp.optimizer.RMSProp import RMSPropOptimizer
...
def manage_optimizer_config() -> None:
    ...
    _AVAILABLE_FLAGS = dict(
        ...
        RMSProp = ("beta2", "eps", "centered", "weight_decay")
    )
...
def get_optimizer(params : flax.core.frozen_dict.FrozenDict,
    ...
    if FLAGS.config.opt.opt_type == "SGD":
        ...
        optimizer_def = RMSPropOptimizer(learning_rate=learning_rate, **FLAGS.config.opt.opt_params)
    else:
